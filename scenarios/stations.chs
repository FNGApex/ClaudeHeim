...
# Runs on the lab (terrain plan phase 5): -Golden ClaudeLab:labtest, stations at fixed spots on the lab stone floor (flatfloor, lab-flat.chs).
...
place piece_workbench @flatfloor+0,2 as bench
...
# --- forge
terrain clear @flatfloor 12
place forge @flatfloor+0,2 as forge
...
terrain clear @flatfloor 12
place piece_chest_wood @flatfloor-2,-2 as chest
fill chest Coal 20
fill chest CopperOre 10
fill chest TinOre 10
place smelter @flatfloor+0,2.5 as smelter
...
# --- charcoal kiln
terrain clear @flatfloor 12
place charcoal_kiln @flatfloor+0,2.5 as kiln
